      ...
      <div class="flex items-center h-16">
        <div class="hidden md:block ml-20">
          ...
          <div class="absolute left-5 top-0 flex items-baseline space-y-8 flex flex-col w-56">
            ...
            <button class="text-gray-300 px-3 py-2 rounded-md text-sm font-bold bg-gray-700" @click="getDataFromServer2">
              不同时间单车需求散点图
            </button>
            <button class="text-white hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-bold"
      ...
      <div class="flex items-center h-16">
        <div class="hidden md:block ml-20">
          ...
          <div class="absolute left-5 top-0 flex items-baseline space-y-8 flex flex-col w-56">
            ...
            <button class="text-gray-300 px-3 py-2 rounded-md text-sm font-bold bg-gray-700" @click="updateChart">
              不同时间单车需求散点图
            </button>
            <button class="text-white hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-bold"
